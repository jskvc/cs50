...
int main(int argc, char* argv[])
{
    ...
    while (true)
    {
        ...
        if (connected())
        {
            ...
            while (k<2)
            {
                abspath[l] = strtok (new[0], "/");;
                l++;
            }
            char* check = strchr(abspath[1], '.');
            if (check == NULL)
            {
            ...
            char path[strlen(root) + strlen(abspath[1]) + 1];
            strcpy(path, root);
            strcat(path, abspath[1]);                     
            ...
            char extension[strlen (exe[1])+1];
            strcpy (extension, exe[1]);
...
const char* lookup(const char* extension)
{
    ...
    if (extension != NULL)
    {
        if (strcmp (extension, "css")||strcmp(extension,"CSS")){
            return "text/css";
        }
        if (strcmp (extension, "html")||strcmp(extension,"HTML")){
            return "text/html";
        }
        if (strcmp (extension, "gif")||strcmp(extension,"GIF")){
            return "text/gif";
        }
        if (strcmp (extension, "ico")||strcmp(extension,"ICO")){
            return "text/x-icon";
        }
        if (strcmp (extension, "jpg")||strcmp(extension,"JPG")){
            return "text/jpeg";
        }
        if (strcmp (extension, "js")||strcmp(extension,"JS")){
